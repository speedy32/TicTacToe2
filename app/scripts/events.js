var Events = function(canvasId){	
	...
	if(this.canvas.tagName != "CANVAS"){
		console.error("Podany obiekt nie jest obiektem canvas");
	} else {
...
Events.prototype.setDrawStage = function(func){
    this.drawStage = func;
    console.log('Events.setDrawStage');
    this.listen();
};
...
Events.prototype.closeRegion = function(){
    ...
    if (pos !== null && this.context.isPointInPath(pos.x, pos.y)) {
        ...
        if (this.mouseDown && this.currentRegion.onmousedown !== undefined) {
            console.log('onMouseDown event started: this.regionIndex='+this.regionIndex+' this.currentRegion.length='+this.currentRegion.length );
        ...
        // handle onmouseup
        	...
        	console.log('onMouseUp event started: this.regionIndex='+this.regionIndex+' this.currentRegion.length='+this.currentRegion.length );
        ...
        // handle onmouseover
        	...
        	console.log('onMouseOver event started: this.regionIndex='+this.regionIndex+' this.currentRegion.length='+this.currentRegion.length );
        ...
        // handle onmousemove
        	...
        	console.log('onMouseMove event started: this.regionIndex='+this.regionIndex+' this.currentRegion.length='+this.currentRegion.length );
